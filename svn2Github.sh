...
for project in $PROJECTS; do
  ...
  # Mettre à jour le fichier pom.xml s'il existe
  if [ -f "pom.xml" ]; then
    # Appel de l'interpréteur Perl pour modifier la balise <scm> (ne fonctionne pas avec seulement sed -i)
    ...
    # Utilisation de l'outil qui permet de modifier un fichier XML
